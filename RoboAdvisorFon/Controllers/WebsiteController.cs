...
namespace RoboAdvisorFon.Controllers
{
    ...
    public class WebsiteController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetCategory(int userId)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                var response = await httpClient.GetAsync(_urls.Safeserver + "api/Fon/getCategory/" + userId);
        ...
        public async Task<IActionResult> GetWebSiteModel(int userid)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                var response = await httpClient.GetAsync(_urls.Safeserver + "api/Fon/GetWebSiteModel/" + userid);
        ...
        public async Task<IActionResult> Tracing(int userId, int? basketid, int? contractId)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                var response = await httpClient.GetAsync(_urls.Safeserver + "api/Fon/Tracing?userId="
        ...
        public async Task<IActionResult> Investment(int BasketID, int ContractID, decimal Amount, int userId)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                var response = await httpClient.GetAsync(_urls.Safeserver + "api/Fon/Investment?BasketID="
        ...
        public async Task<IActionResult> SurveyView()
        {
            ...
            using (var httpClient = new HttpClient())
            {
                var response = await httpClient.GetAsync(_urls.Safeserver + "api/Fon/SurveyView");
        ...
        public async Task<IActionResult> PostInvestment(InvestmentModel model)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                var response = await httpClient.PostAsync(_urls.Safeserver + "api/Fon/PostInvestment", c);
        ...
        public async Task<IActionResult> PostAnswers(List<AnswersDto> answers)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                var response = await httpClient.PostAsync(_urls.Safeserver + "api/Fon/PostAnswers", c);
