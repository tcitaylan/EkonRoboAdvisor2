...
export class SurveyresultComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private route: ActivatedRoute,
    ...
    , public auth: AuthService, private errorp: ErrorServiceService
  ...
  ngOnInit() {
    ...
    //this.errorp.changeError(true);
    //console.log('ISERROR:  '+this.errorp.iserr);
  ...
  getWebSiteModel(uidf: string) {
    this.http
      ...
      .subscribe(
        response => {
          this.sm = response;
          console.log('surres: ' + JSON.stringify(this.sm));
