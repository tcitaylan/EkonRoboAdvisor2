...
export class InvestmentComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private http: HttpClient, private router: Router,
    ...
    public errorpage: ErrorServiceService) { }
  ...
  getInvModel(basketId: string) {
    //console.log(environment.apiUrl + '/website/Investment?basketId=' + basketId + '&contractId=' + this.selectedContId + '&amount='
    ...
    this.http
      ...
      .subscribe(
        response => {
          ...
          this.im = response;          
          if (this.im.symbolList.length === 0) {
            this.errorpage.changeError(true);           
          }
